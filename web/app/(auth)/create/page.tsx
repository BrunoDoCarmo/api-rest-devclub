...
const CreatePage = () => {
    ...
    const renderStep = () => {
        ...
        case 2: return (
            <StepUser
                dataUser={state.user} 
                onChangeUser={actions.setUser}
                dataMemberships={state.memberships} 
                onChangeMemberships={actions.setMemberships}
                activeSubTab={state.userTab} // Nova prop
            />
        );
        default: return null;
        }
    ...
    const handleFinalStep = () => {
        if (state.activeTab === 2 && state.userTab === 1) {
                ...
                <div className="flex items-center justify-center p-6 w-full">
                    <div className="w-full max-w-[600px] bg-white rounded-2xl shadow-2xl p-8 transition-all">
                        ...
                        <div className="mt-10 flex justify-between gap-4">
                            ...
                            >
                                {state.activeTab === 2 && state.userTab === 1 ? "Finalizar Cadastro" : "Próximo passo"}
                            </button>
                        </div>
                    </div>
                </div>
